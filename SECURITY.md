...
- Expose only the Minecraft game port through FRP or router forwarding.
- Do not forward port `8765`.
- Only import server packs and Mods from sources you trust. Launch scripts are executable code.
